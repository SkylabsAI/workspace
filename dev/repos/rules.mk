...
ONLY_${REPO_VIS}_CLONE_TARGETS += clone-${REPO_NAME}
ONLY_${REPO_MODE}_CLONE_TARGETS += clone-${REPO_NAME}
...
ONLY_${REPO_VIS}_LIGHTWEIGHT_CLONE_TARGETS += lightweight-clone-${REPO_NAME}
ONLY_${REPO_MODE}_LIGHTWEIGHT_CLONE_TARGETS += lightweight-clone-${REPO_NAME}
...
ONLY_${REPO_VIS}_NUKE_TARGETS += nuke-${REPO_NAME}
ONLY_${REPO_MODE}_NUKE_TARGETS += nuke-${REPO_NAME}
...
ONLY_${REPO_VIS}_DESCRIBE_TARGETS += describe-${REPO_NAME}
ONLY_${REPO_MODE}_DESCRIBE_TARGETS += describe-${REPO_NAME}
...
ONLY_${REPO_VIS}_FETCH_TARGETS += fetch-${REPO_NAME}
ONLY_${REPO_MODE}_FETCH_TARGETS += fetch-${REPO_NAME}
...
ONLY_${REPO_VIS}_PULL_TARGETS += pull-${REPO_NAME}
ONLY_${REPO_MODE}_PULL_TARGETS += pull-${REPO_NAME}
...
ONLY_${REPO_VIS}_PUSH_TARGETS += push-${REPO_NAME}
ONLY_${REPO_MODE}_PUSH_TARGETS += push-${REPO_NAME}
...
ONLY_${REPO_VIS}_PEEK_TARGETS += peek-${REPO_NAME}
ONLY_${REPO_MODE}_PEEK_TARGETS += peek-${REPO_NAME}
...
ONLY_${REPO_VIS}_GITCLEAN_TARGETS += gitclean-${REPO_NAME}
ONLY_${REPO_MODE}_GITCLEAN_TARGETS += gitclean-${REPO_NAME}
...
ONLY_${REPO_VIS}_CHECKOUT_MAIN_TARGETS += checkout-main-${REPO_NAME}
ONLY_${REPO_MODE}_CHECKOUT_MAIN_TARGETS += checkout-main-${REPO_NAME}
.PHONY: checkout-main-${REPO_NAME}
checkout-main-${REPO_NAME}:
ifeq ($(wildcard ${REPO_DIR}),${REPO_DIR})
	@echo "Resetting ${REPO_DIR} to ${REPO_DEFAULT}:"
...
.PHONY: $1-only-public
$1-only-public: $$(ONLY_public_$(call VAR_OF_TARGET_BASE,$1)_TARGETS)
endef
